  ...
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        ...
        <el-button v-if="isAuth('goodsorder_manage:goodsorder:save')" type="primary" @click="addOrUpdateHandle()">新增</el-button>
    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          ...
          <el-button type="text" size="small" @click="successHandle(scope.row.id)" :disabled="fkqrconfirm(scope.row.zztdm)">确认送达并支付</el-button>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      successHandle (id) {
        this.fkqrid = id
        this.fkqrVisible = true
      },
      fkqrSubmit () {
        this.$http({
          url: this.$http.adornUrl(`/goodsorder_manage/goodsorder/qrfkinfo/${this.fkqrid}`),
          method: 'post',
